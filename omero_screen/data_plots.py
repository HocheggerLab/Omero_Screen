    ...
    for experiment in data_IF["experiment"].unique():
        for cell_line in data_IF.loc[data_IF["experiment"] == experiment]["cell_line"].unique():
            for condition in data_IF.loc[(data_IF["experiment"] == experiment) &
                ...
                Figure.savefig(str(path_export) + "EdU-DAPI_" + experiment + "_" + cell_line + "_" + condition + ".pdf",
                               dpi=300)
                Figure.savefig(str(path_export)+ "EdU-DAPI_" + experiment + "_" + cell_line + "_" + condition + ".png",
                               dpi=1000)
                del (tmp_data)
    ...
    for experiment in data_IF["experiment"].unique():
        for cell_line in data_IF.loc[data_IF["experiment"] == experiment]["cell_line"].unique():
            ...
            for condition in data_IF.loc[(data_IF["experiment"] == experiment) &
                ...
                Figure.savefig(str(path_export) + "H3P_" + experiment + "_" + cell_line + "_" + condition + ".pdf", dpi=300)
                Figure.savefig(str(path_export) + "H3P_" + experiment + "_" + cell_line + "_" + condition + ".png", dpi=1000)
                del (tmp_data)
